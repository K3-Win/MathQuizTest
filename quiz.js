...
const quizData = {
  ...
  2: [
    // สมการ
    { q: "x + 15 = 40, x คือ?", a: 25 },
    { q: "y - 12 = 30, y คือ?", a: 42 },
    { q: "5a = 150, a คือ?", a: 30 },
    { q: "2b + 10 = 50, b คือ?", a: 20 },
    {
  ...
  3: [
    // ห.ร.ม. ค.ร.น.
    { q: "ตัวประกอบทั้งหมดของ 12 มีกี่ตัว?", a: 6 },
    { q: "ห.ร.ม. ของ 18 และ 24 คือ?", a: 6 },
    { q: "ค.ร.น. ของ 6 และ 8 คือ?", a: 24 },
    { q: "ห.ร.ม. ของ 15, 30 และ 45 คือ?", a: 15 },
    {
      q: "ระฆัง 3 ใบ ตีทุก 10, 15 และ 20 นาที ถ้าระฆังตีพร้อมกันเวลา 8.00 น. จะตีพร้อมกันอีกครั้งเวลาใด (ตอบเป็นตัวเลขเช่น 9.00)",
      a: "9.00",
    },
  ],
  4: [
  ...
  8: [
    // บัญญัติไตรยางศ์
    { q: "สมุด 3 เล่ม ราคา 30 บาท สมุด 1 เล่ม ราคากี่บาท?", a: 10 },
  ...
  9: [
    // อัตราส่วนและร้อยละ
    { q: "ร้อยละ 20 เขียนเป็นเศษส่วนอย่างต่ำคือ?", a: "1/5" },
  ...
  11: [
    // พื้นที่และรอบรูป
    { q: "สี่เหลี่ยมจัตุรัสยาวด้านละ 5 ซม. มีเส้นรอบรูปกี่ ซม.?", a: 20 },
  ...
  12: [
    ...
    { q: "น้ำ 1 ลิตร มีปริมาตรกี่ ลบ.ซม.?", a: 1000 },
  ...
  13: [
    // สถิติ
    { q: "ค่าเฉลี่ยของ 4, 6, 8, 10 คือ?", a: 7 },
  ...
  14: [
    ...
    {
      q: "พ่อค้าซื้อไข่ 150 ฟอง แตกไป 10% นำไข่ที่เหลือไปขายฟองละ 5 บาท จะได้เงินกี่บาท?",
      a: 675,
    },
    {
